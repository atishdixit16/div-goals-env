        ...
        for y, x in idxes:
            ...
            batch.add(
                ...
                (
                    "v2f",
                    (
                        (self.grid_size + 1) * x + _GOAL_PADDING + 1,  # TL - X
                        (self.grid_size + 1) * y + _GOAL_PADDING + 1,  # TL - Y
                        (self.grid_size + 1) * (x + 1) - _GOAL_PADDING,  # TR - X
                        (self.grid_size + 1) * y + _GOAL_PADDING + 1,  # TR - Y
                        (self.grid_size + 1) * (x + 1) - _GOAL_PADDING,  # BR - X
                        (self.grid_size + 1) * (y + 1) - _GOAL_PADDING,  # BR - Y
                        (self.grid_size + 1) * x + _GOAL_PADDING + 1,  # BL - X
